...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 7897 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 1283 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 1856 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 19421 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 32074 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 29314 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 31381 };
      jobHistory.job = job;
      const department: IDepartment = { id: 21892 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 3491 };
      jobHistory.employee = employee;
