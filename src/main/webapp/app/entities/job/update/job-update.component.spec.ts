...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 14540 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 5978 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 29377 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 21380 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 2945 };
      job.tasks = [task];
      const employee: IEmployee = { id: 26611 };
      job.employee = employee;
